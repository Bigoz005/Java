...
public class zad4 {
	...
	static int NUMBER_OF_CHARACTERS = 1000;
	
	static int FIRST_ASCII_CHAR = 32;
	static int LAST_ASCII_CHAR = 126;
	...
	public static void main(String[] args) {
		...
		test("java.io", "plik1.txt", new PlikIO(), tab);
		test("java.nio", "plik2.txt", new PlikNIO(), tab);
	}
